// services/enrichment-services/reportTextExtractionService.js
...
/**
 * Extract text from annual reports
                ...
                if (companyData &&
                    ...
                    if (originalIndex !== -1) {
                        processedData[originalIndex] = {
                            ...
                            annualReportRawText: companyData.annual_report_raw
                        };
                    }
                    ...
                    if (!rawText || typeof rawText !== 'string' || rawText.startsWith("Error")) {
...
async function extractTextFromPdf(pdfUrl, maxRetries, retryDelay, logCallback) {
    for (let attempt = 0; attempt < maxRetries; attempt++) {
        try {
            ...
            // Add a random delay before the request to avoid rate limiting
