// services/apolloEnrichmentService.js
...
/**
 * Process Apollo enrichment for a batch of data
...
export async function processApolloEnrichment(data, logCallback, progressCallback) {
  ...
  logCallback(`Apollo Lead Enrichment Complete:`);
...
/**
 * Process a single lead through Apollo
