// services/videocx/apolloEnrichmentService.jsx
...
/**
 * Process Apollo enrichment for a batch of data for VideoCX
...
export async function processApolloEnrichment(data, logCallback, progressCallback) {
  logCallback("Starting VideoCX Apollo Lead Enrichment...");
  ...
  logCallback(`VideoCX Apollo Lead Enrichment Complete:`);
...
/**
 * Upsert data to Supabase for VideoCX
...
/**
 * Process a single lead through Apollo for VideoCX
    ...
    if (supabaseAvailable) {
      ...
      try {
        ...
        if (fetchError && fetchError.code !== 'PGRST116') {
          ...
          // This block is missing in the original code
    ...
    try {
      ...
      while (retryCount <= maxRetries) {
        try {
          ...
          // MODIFIED: Use proxy server endpoint instead of direct API call
